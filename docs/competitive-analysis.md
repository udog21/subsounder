...
Users who successfully cancel can confirm or correct the cancel URL and difficulty — crowdsourced accuracy improvement.
...
- User correction signals (Layer 3) — post-launch feedback loop
